...
function t_lazyload__onWindowResize() {
	if ((t_lazyload_update(), "yes" !== window.lazy_imgoptimoff)) {
		var e = document.querySelectorAll(".t-cover__carrier, .t-bgimg, .t-img");
	...
	if (void 0 !== navigator.sendBeacon) {
		...
		if (n) {
			...
			0 === n.indexOf("https://" + t_lazyload__getThumbDomainName()) &&
				(a.th = "y"),
				0 === n.indexOf("https://static.tildacdn") && (a.st = "y"),
				(a.th || a.st) && window.t_loadImgStats.push(a);
		}
	}
}
	...
	(n.src = t + "/pixel.png"),
		...
		setTimeout(function () {
			if ("y" !== window["lazy_ok_" + e]) {
				(window["lazy_err_" + e] = "y"), console.log(e + " ping error");
	...
	(function (e, t) {
		...
		function d() {
			i ||
				...
				(o = "IntersectionObserver" in window),
				(i = !0),
				(n = [
					"200x151",
					"640x712",
		...
		function h(e, t, i, o) {
			...
			if (l) {
				var d = t.clientWidth,
					...
					c;
				if (
					(_(t, "t-slds__bgimg") || _(t, "t-slds__img")) &&
					!_(t, "t827__image")
				)
					(c = g(t, "t-slds__wrapper")) || (c = g(t, "t-slds__container")),
						!1 === m(c) && (c = g(t, "t-slds__thumbsbullet")),
						m(c) && ((d = c.clientWidth), (s = c.clientHeight));
				if (_(t, "tn-atom") && _(t, "t-bgimg"))
					if (m((c = g(t, "tn-atom__scale-wrapper")))) {
						var u = c.getBoundingClientRect(),
							x;
						(d = (x = v("round", u.width, u.height, 10))[0]), (s = x[1]);
					}
				var p = "",
					w = "",
					h = "",
					...
					if (M)
						"50%" == (p = (x = M.split(" "))[0])
							...
							"50%" == (w = x[1])
								...
								? (w = "top")
								: "100%" == w && (w = "bottom");
					(k = "contain" == (h = N.backgroundSize) ? "contain" : "cover"),
						"fixed" == (O = N.backgroundAttachment) && (S = !0);
				} else S = !0;
				if ((I = t.getAttribute("data-lazy-rule"))) {
					var T = I.split(","),
						R;
					for (R = 0; R < T.length; R++)
						T[R].indexOf("round:") > -1 && (L = 1 * T[R].split(":")[1]),
							T[R].indexOf("comm:") > -1 &&
								"resize" != (k = T[R].split(":")[1]) &&
								"cover" != k &&
								"contain" != k &&
								(E = !1),
							T[R].indexOf("skip") > -1 && (S = !0),
							T[R].indexOf("optimoff") > -1 && (E = !1);
				}
				if (L > 1) (d = (x = v(k, d, s, L))[0]), (s = x[1]);
				if ("cover" == k && d > 0 && s > 0 && d <= 1e3)
					if (d === 5 * Math.ceil(d / 5) && s === 5 * Math.ceil(s / 5));
					else if (n.indexOf(d + "x" + s) > -1);
					else if (a.indexOf(d + "x" + s) > -1);
					else if (_(t, "tn-atom") || _(t, "tn-atom__img"));
					else {
						var x;
						_(t, "t-cover__carrier") || (k = "resize"),
							(d = (x = v(k, d, s, 100))[0]),
							(s = x[1]);
					}
				if (
					...
					if ("IMG" === e.tagName) e.setAttribute("src", l);
						...
						if (-1 !== e.style.backgroundImage.indexOf("-gradient("))
							j = e.style.backgroundImage.split("), ")[1];
						j
							? (e.style.backgroundImage = "url(" + l + "), " + j)
							: ((e.style.backgroundImage = "url(" + l + ")"), b(e, l));
					}
		...
		function b(e, t) {
			...
			if (i) {
				var n = t.split(".");
				n = n[n.length - 1];
				var a = document.getElementById("recorddiv" + i);
				"svg" === n && (a.style.backgroundImage = "");
			}
		}
		function v(e, t, i, n) {
			if ("cover" == e && t > 0 && i > 0) {
				...
				a <= 1
					...
					: (a >= 1.25 && (o = 1.25),
					  ...
					  (i = Math.ceil(t / o)),
					  (i = 10 * Math.ceil(i / 10)));
			} else t > 0 && (t = Math.ceil(t / n) * n), i > 0 && (i = Math.ceil(i / n) * n);
			return [t, i];
		}
		function A(e, t, i, n, a, o, r) {
			...
			var l = 1,
				d;
			if (
				(1 === window.devicePixelRatio && Math.max(n, a) <= 400 && (l = 1.2),
				window.devicePixelRatio > 1 && (l = 2),
				n > 0 && (n = parseInt(l * n)),
				a > 0 && (a = parseInt(l * a)),
				n > 1e3 || a > 1800)
			)
			...
			if ("resize" == t) {
				...
				if (n <= 0 && a <= 0) return i;
				var s;
				"left" !== o && "right" !== o && (o = "center"),
					"top" !== r && "bottom" !== r && (r = "center"),
					(s = i.split("/")).splice(
						i.split("/").length - 1,
						0,
						"-/" +
			...
			var c = document.getElementById("allrecords"),
				u = c && "y" === c.getAttribute("data-tilda-ts");
			return "y" == window.lazy_webp && u && (d += ".webp"), d;
		}
		function z(e) {
			...
			var t = e.split("/");
			t.splice(e.split("/").length - 1, 0, "-/format/webp");
			var i = w(t.join("/")),
				n = document.getElementById("allrecords"),
				a;
			return n && "y" === n.getAttribute("data-tilda-ts") && (i += ".webp"), i;
		}
		function O(e, t, i) {
			if ("string" == typeof t && null != t && "" != t) {
				var n;
				if ((console.log("lazy loading err"), y(t)))
					return (
						(window.lazy_err_static = "y"),
						void k(e, (n = t.replace(r, "/static3.tildacdn.com/")))
					);
				if (
					...
					if (a.length > 3)
						for (var d = 0; d < a.length; d++)
							"" !== a[d] &&
								("til" == a[d].substring(0, 3) &&
									36 == a[d].length &&
									4 == (a[d].match(/-/g) || []).length &&
									(o = a[d]),
								d == a.length - 1 && (l = a[d]));
					if ("" !== o && "" !== l)
						k(e, (n = "https://static3.tildacdn.com/" + o + "/" + l));
		...
		function I(t) {
			d(),
				...
				o && this._initializeObserver(),
				this.update(),
				this.loadAnimatedImages();
		}
		return (
			(I.prototype._showOnLoad = function (e) {
				var t,
					i = this._settings,
					n;
				function a() {
					null !== i &&
						...
						h(e, e, i.data_srcset, i.data_src),
				...
				!e.getAttribute("src") &&
					...
					(t = document.createElement("img")).addEventListener("load", a),
					t.addEventListener("error", function (t) {
						f(e, i.class_loading),
							i.callback_error && i.callback_error(e),
							void 0 !== t.path
								? O(e, t.path[0].currentSrc, n)
								: void 0 !== t.target && O(e, t.target.currentSrc, n);
					}),
					x(e, i.class_loading),
					(n = s()),
					h(t, e, i.data_srcset, i.data_src);
			}),
			(I.prototype._showOnAppear = function (e) {
				...
				("IMG" !== e.tagName && "IFRAME" !== e.tagName) ||
					...
					e.addEventListener("error", function (a) {
						e.removeEventListener("load", n),
							...
							void 0 !== a.path
								? O(e, a.path[0].currentSrc, i)
								: void 0 !== a.target && O(e, a.target.currentSrc, i);
					}),
					x(e, t.class_loading)),
					(i = s()),
					h(e, e, t.data_srcset, t.data_src),
			...
			(I.prototype._initializeObserver = function () {
				var e = this;
				this._intersectionObserver = new IntersectionObserver(
					function (t) {
						...
						t.forEach(function (t) {
							...
							if (
								!(
									e._settings.skip_invisible &&
									n.isSkipByPosition &&
									n.isNotUnderScreenRange
								)
							) {
								var a = t.boundingClientRect.top + i < 0,
									o = n.closest(".t396__elem"),
									r = o && 0 === o.style.top.indexOf("-");
								if (n.wasProcessed)
									return (
			...
			(I.prototype.loadAnimatedImages = function () {
				var e,
					t,
					i = this._settings,
					n = this._elements,
				...
				function r(e, t) {
					...
					if (!n) return !1;
					var a = p(e),
						r = Math.abs(n.top - a.top),
						l = Math.abs(n.left - a.left);
					return r > i.threshold || l > i.threshold;
				}
				for (e = 0; e < a; e++)
					if (_((t = n[e]), "tn-atom__img") || _(t, "tn-atom")) {
						var l = g(t, "tn-elem"),
			...
			if ("IMG" == t)
				...
				var a = getComputedStyle(e),
					i = a.backgroundImage
						...
						.replace(")", "")
						.replace(/"/gi, "");
				if ("contain" === a.backgroundSize) var n = "-/contain/";
				else var n = "-/cover/";
			} else var n = "-/cover/";
			if (
				!(
					...
					i.indexOf(".gif") > 0 ||
					i.indexOf(".ico") > 0 ||
					-1 === i.indexOf(t_lazyload__getThumbDomainName()) ||
					(i.indexOf("-/empty/") > 0 && i.indexOf("-/resizeb/") > 0)
				)
			) {
				var o = i.indexOf(n) + n.length,
					r = i.indexOf("/", o);
				if (o > 0 && r > 0) {
					var l = i.slice(o, r).split("x"),
						d = e.clientWidth,
						s = e.clientHeight;
					if (
						d > 0 &&
						s > 0 &&
						(l[0] > 0 || l[1] > 0) &&
						((l[0] > 0 && d > l[0]) || (l[1] > 0 && s > l[1])) &&
						((l[0] > 0 && d - l[0] > 100) || (l[1] > 0 && s - l[1] > 100))
					) {
						var c =
							i.slice(0, o) +
							(l[0] > 0 ? d : "") +
