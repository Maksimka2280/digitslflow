!(function () {
	...
	var jr = {
		...
		Yr = (Ke.exports = function (t, e, r) {
			...
			var n = Ur(t);
			return (
				Lr(n, "source") || (n.source = Vr(Gr, "string" == typeof e ? e : "")), t
			);
		});
	...
	var Wo =
			...
			function (t, e) {
				...
				return (
					null !== t
						? ((Fo[Co] = jo(t)), (r = new Fo()), (Fo[Co] = null), (r[Uo] = t))
						: (r = Ho()),
					void 0 === e ? r : Po.f(r, e)
				);
			},
	...
	var Ui =
		...
		ou = function (t, e) {
			var r = (Qa[t] = va(Wa));
			return (
				Fa(r, { type: Na, tag: t, description: e }),
				ia || (r.description = e),
				r
			);
		},
		...
		uu = function (t) {
			...
			return (
				...
				(!(r || !ca(this, e) || !ca(Qa, e) || (ca(this, Ca) && this[Ca][e])) ||
					r)
			);
		},
		cu = function (t, e) {
			...
			if (r !== za || !ca(Qa, n) || ca(Za, n)) {
				var o = Ya(r, n);
				return (
					!o || !ca(Qa, n) || (ca(r, Ca) && r[Ca][n]) || (o.enumerable = !0), o
				);
			}
		},
		su = function (t) {
	...
	var _c = E,
		...
		Ds = function (t, e) {
			var r = {};
			(r[t] = Ps(t, e, Ls)),
				Ms({ global: !0, constructor: !0, arity: 1, forced: Ls }, r);
		},
		Cs = function (t, e) {
			if (ks && ks[t]) {
				var r = {};
				(r[t] = Ps(_s + "." + t, e, Ls)),
					Ms(
						{ target: _s, stat: !0, constructor: !0, arity: 1, forced: Ls },
						r
					);
			}
		};
	...
	oo(
		...
		},
		{
			of: function () {
				for (
					var t = 0, e = arguments.length, r = new (Ld(this) ? this : Cd)(e);
					e > t;
	...
	if (Dy) {
		...
		(lm = (fm = function (t) {
			...
			(hm = function (t, e, r) {
				...
				if (i + (r = void 0 === r ? o - i : Hy(r)) > o)
					throw new gm("Wrong length");
				cm(this, {
					type: nm,
					buffer: t,
					byteLength: r,
	...
	var km = { ArrayBuffer: fm, DataView: hm },
		...
		Cm = km[Dm];
	oo(
		{ global: !0, constructor: !0, forced: o[Dm] !== Cm },
		{ ArrayBuffer: Cm }
	),
		Lm(Dm);
	var Nm,
	...
	for (Nm in yb)
		(Fm = (Um = Hm[Nm]) && Um.prototype) ? (rb(Fm)[db] = Um) : (vb = !1);
	...
	oo(
		{ target: "ArrayBuffer", stat: !0, forced: !Eb.NATIVE_ARRAY_BUFFER_VIEWS },
		{ isView: Eb.isView }
	);
	var Ab = oo,
		Sb = bi,
		...
		Cw =
			...
			function (t, e, r) {
				var n,
					...
					a = !_w || !_w(t);
				if (
					(Ew(t), Ow && ((t = Tw(t, { transfer: [t] })), o === i && (r || a)))
				)
					return t;
				if (o >= i && (!r || a)) n = Pw(t, 0, i);
					...
					n = new xw(i, u);
					for (
						var c = new Rw(t), s = new Rw(n), f = Iw(i, o), l = 0;
						l < f;
						l++
					)
						Dw(s, l, Lw(c, l));
	...
	var Qw = an,
		...
		fE = function (t) {
			return function (e, r, n) {
				...
				return u <= c || "" === s
					? a
					: ((i = uE(s, sE((o = u - c) / s.length))).length > o &&
							(i = cE(i, 0, o)),
					  t ? a + i : i + a);
			};
		},
		...
		IE =
			pE(function () {
				return (
					"0385-07-25T07:06:39.999Z" !== bE.call(new Date(-50000000000001))
				);
			}) ||
			!pE(function () {
		...
		ME = IE;
	oo(
		{ target: "Date", proto: !0, forced: Date.prototype.toISOString !== ME },
		{ toISOString: ME }
	);
	var jE = Bt,
		PE = le;
	...
	var oA = E,
		...
		vA = dA;
	oo(
		{ target: "Function", proto: !0, forced: Function.bind !== vA },
		{ bind: vA }
	);
	var gA = F,
		yA = z,
	...
	var _A = oo,
		...
		KA = function () {
			if ((LA(this, HA), NA(this) === HA))
				throw new YA("Abstract class Iterator not directly constructable");
		},
		JA = function (t, e) {
			WA
				? UA(HA, t, {
						...
						set: function (e) {
							if ((DA(this), this === HA))
								throw new YA("You can't redefine this property");
	...
	var wS = function (t, e, r) {
		...
		RS = wS(function () {
			for (var t, e = this.iterator, r = this.next; this.remaining; )
				if ((this.remaining--, (t = SS(AS(r, e))), (this.done = !!t.done)))
					return;
	...
	var pO = l,
		...
		mO = wS(function () {
			var t = this.iterator,
				e = vO(pO(this.next, t));
			if (!(this.done = !!e.done))
				return yO(t, this.mapper, [e.value, this.counter++], !0);
		}),
		bO = function (t) {
	...
	var zO = { exports: {} },
		...
		$O =
			WO(function () {
				...
				? function (t) {
						return (
							!!VO(t) && (!GO || "ArrayBuffer" !== qO(t)) && (!YO || YO(t))
						);
				  }
				: YO,
		XO = !a(function () {
					...
					jT(i, {
						...
						forEach: function (t) {
							for (
								var e,
									r = a(this),
									n = PT(t, arguments.length > 1 ? arguments[1] : void 0);
								(e = e ? e.next : r.first);
	...
	ox(
		{
			...
			stat: !0,
			forced:
				!ax || 710 !== Math.floor(ax(Number.MAX_VALUE)) || ax(1 / 0) !== 1 / 0,
		},
		{
			acosh: function (t) {
				var e = +t;
	...
	oo({ target: "Math", stat: !0 }, { log10: Wx }),
		oo({ target: "Math", stat: !0 }, { log1p: nx });
	var Vx = Math.log,
		qx = Math.LN2,
		Gx =
			Math.log2 ||
	...
	var $R = o,
		...
		oI = nI;
	oo(
		{ target: "Number", stat: !0, forced: Number.parseFloat !== oI },
		{ parseFloat: oI }
	);
	var iI = o,
		aI = a,
		...
		yI = gI;
	oo(
		{ target: "Number", stat: !0, forced: Number.parseInt !== yI },
		{ parseInt: yI }
	);
	var mI = oo,
		bI = E,
	...
	var CI = oo,
		...
		XI = function (t, e, r) {
			for (var n = -1, o = r; ++n < 6; )
				(o += e * t[n]), (t[n] = o % 1e7), (o = VI(o / 1e7));
		},
		KI = function (t, e) {
			for (var r = 6, n = 0; --r >= 0; )
				(n += t[r]), (t[r] = VI(n / e)), (n = (n % e) * 1e7);
		},
		JI = function (t) {
			for (var e = 6, r = ""; --e >= 0; )
				if ("" !== r || 0 === e || 0 !== t[e]) {
			...
			toFixed: function (t) {
				...
				if ((i < 0 && ((c = "-"), (i = -i)), i > 1e-21))
					if (
						...
						for (XI(u, $I(10, n, 1), 0), n = e - 1; n >= 23; )
							KI(u, 1 << 23), (n -= 23);
	...
	var rM = u,
		...
		dM =
			...
			iM(function () {
				...
				? function (t, e) {
						for (
							var r = sM(t), n = arguments.length, o = 1, i = uM.f, a = cM.f;
							n > o;
		...
		vM = dM;
	oo(
		{ target: "Object", stat: !0, arity: 2, forced: Object.assign !== vM },
		{ assign: vM }
	),
	...
	oo(
		{ target: "Object", stat: !0, sham: !u },
		{
			getOwnPropertyDescriptors: function (t) {
				for (
					var e, r, n = nj(t), o = oj.f, i = rj(n), a = {}, u = 0;
					i.length > u;
	...
	var Oj = $O;
	oo(
		{ target: "Object", stat: !0, forced: Object.isExtensible !== Oj },
		{ isExtensible: Oj }
	);
	var Tj = oo,
		xj = a,
	...
	(ZP && t_) ||
		...
		QP
			...
			: o_ && !JP
			? ((IP = (RP = new o_()).port2),
			  (RP.port1.onmessage = l_),
			  (xP = WP(IP.postMessage, IP)))
			: zP.addEventListener &&
			  VP(zP.postMessage) &&
			  !zP.importScripts &&
			  TP &&
	...
	var W_,
		...
		uk = Z_("Promise", function () {
			...
			if (!nk || nk < 51 || !/native code/.test(t)) {
				...
				if (
					(((r.constructor = {})[ok] = n),
					!(ik = r.then(function () {}) instanceof n))
				)
					return !0;
			}
		...
		hk = function (t) {
			...
			(this.promise = new t(function (t, n) {
				if (void 0 !== e || void 0 !== r)
					throw new lk("Bad Promise constructor");
				(e = t), (r = n);
			})),
				(this.resolve = fk(e)),
				(this.reject = fk(r));
		...
		Zk = function (t, e, r) {
			...
			$k
				...
				!Ck && (o = vk["on" + t])
					? o(n)
					: t === Xk && Ik("Unhandled promise rejection", r);
		},
		tL = function (t) {
			gk(xk, vk, function () {
				var e,
		...
		rL = function (t) {
			gk(xk, vk, function () {
				var e = t.facade;
				dk
					? qk.emit("rejectionHandled", e)
					: Zk("rejectionhandled", e, t.value);
			});
		},
		nL = function (t, e, r) {
			return function (n) {
		...
		oL = function (t, e, r) {
			t.done ||
				((t.done = !0), r && (t = r), (t.value = e), (t.state = 2), Qk(t, !0));
		},
		iL = function (t, e, r) {
			if (!t.done) {
				(t.done = !0), r && (t = r);
	...
	pk({ global: !0, constructor: !0, wrap: !0, forced: Dk }, { Promise: zk }),
		bk(zk, Lk, !1, !0),
		wk(Lk);
	var aL = X_,
		uL =
	...
	var hC = z,
		...
		SC = function (t) {
			var e = t.flags;
			return void 0 !== e || "flags" in AC || bC(t, "flags") || !wC(AC, t)
				? e
				: mC(EC, t);
		},
		OC = a,
		...
		mN =
			...
			(!vN ||
				...
				JC(function () {
					return (
						(dN[nN] = !1),
						oN(pN) !== pN || oN(dN) === dN || "/a/i" !== String(oN(pN, "i"))
					);
				}));
	if (FC("RegExp", mN)) {
		for (
								...
								for (
									...
									if ("\\" === (e = cN(t, n))) e += cN(t, ++n);
										...
										switch (!0) {
											...
											case ">" === e && c:
												if ("" === f || QC(a, f))
													throw new aN("Invalid capture group name");
	...
	var MN = l,
		...
		qN = (function () {
			var t = /a/,
				e = /b*/g;
			return (
				MN(FN, t, "a"), MN(FN, e, "a"), 0 !== t.lastIndex || 0 !== e.lastIndex
			);
		})(),
		GN = kN.BROKEN_CARET,
		YN = void 0 !== /()??/.exec("")[1];
	(qN || YN || GN || CN || NN) &&
		(BN = function (t) {
			...
			if (
				...
				for (o.groups = a = LN(null), i = 0; i < h.length; i++)
					a[(u = h[i])[0]] = o[u[1]];
			return o;
		});
	var $N = BN;
	...
	var XN = u,
		...
		eU =
			...
			QN(function () {
				...
				return (
					Object.getOwnPropertyDescriptor(tU, "flags").get.call(e) !== n ||
					r !== n
				);
			});
	...
	var tB = kU,
		...
		cB = uB;
	oo(
		{ target: "Set", proto: !0, real: !0, forced: !mF("symmetricDifference") },
	...
	var sB = kU,
		...
		vB = dB;
	oo(
		{ target: "Set", proto: !0, real: !0, forced: !mF("union") },
		{ union: vB }
	);
	var gB = oo,
		yB = L,
		...
		{ target: "String", stat: !0, arity: 1, forced: !!tz && 1 !== tz.length },
		{
			fromCodePoint: function (t) {
				for (var e, r = [], n = arguments.length, o = 0; n > o; ) {
					if (((e = +arguments[o++]), JB(e, 1114111) !== e))
						throw new QB(e + " is not a valid code point");
					r[o] =
						e < 65536
							? ZB(e)
							: ZB(55296 + ((e -= 65536) >> 10), (e % 1024) + 56320);
				}
				return ez(r, "");
			},
		}
		...
		{ target: "String", proto: !0 },
		{
			isWellFormed: function () {
				for (var t = fz(sz(this)), e = t.length, r = 0; r < e; r++) {
					...
					if (
						55296 == (63488 & n) &&
						(n >= 56320 || ++r >= e || 56320 != (64512 & lz(t, r)))
					)
						return !1;
				}
				return !0;
	...
	vz(
		...
		function () {
			...
			return n >= r.length
				? gz(void 0, !0)
				: ((t = hz(r, n)), (e.index += t.length), gz(t, !1));
		}
	);
	var wz = l,
		Ez = Zr,
		...
		return [
			...
			function (t) {
				...
				for (var u, c = [], s = 0; null !== (u = Gz(n, o)); ) {
					var f = Hz(u[0]);
					(c[s] = f),
						"" === f && (n.lastIndex = qz(o, zz(n.lastIndex), a)),
						s++;
				}
				return 0 === s ? null : c;
			},
		...
		AH = Kz(
			...
			function () {
				...
				return null === n
					...
					: t.global
					? ("" === tH(n[0]) &&
							(e.lastIndex = sH(r, Zz(e.lastIndex), t.unicode)),
					  Jz(n, !1))
					: ((t.done = !0), Jz(n, !1));
			}
		),
	...
	Iz("search", function (t, e, r) {
		return [
			...
			function (t) {
				...
				var u = FW(n, o);
				return (
					CW(n.lastIndex, a) || (n.lastIndex = a), null === u ? -1 : u.index
				);
			},
		];
	});
			...
			return [
				...
				function (t, o) {
					...
					for (var p = 0, d = 0, v = []; d < a.length; ) {
						...
						if (
							null === y ||
							(g = tV($W(l.lastIndex + (ZW ? d : 0)), a.length)) === p
						)
							d = YW(a, d, s);
						else {
	...
	oo(
		{ target: "String", proto: !0, name: "trimEnd", forced: "".trimEnd !== HV },
		{ trimEnd: HV }
	);
	var WV = lR.start,
		VV = FV("trimStart")
	...
	var lq = { exports: {} },
		...
		Bq = function (t) {
			var e,
				...
				d = Dq(f);
			if (d && !Cq(d))
				for (c = (u = Lq(f, d)).next, f = []; !(a = jq(c, u)).done; )
					f.push(a.value);
			for (
				p && l > 2 && (h = Mq(h, arguments[2])),
					r = kq(f),
					n = new (Uq(s))(r),
					o = Nq(n),
					e = 0;
		...
		CG = function (t) {
			var e;
			return (
				cG(xG, t) || "ArrayBuffer" === (e = oG(t)) || "SharedArrayBuffer" === e
			);
		},
		NG = function (t, e) {
	...
	Vq
		? (IG ||
				...
				DG(PG, "length")),
		  zq(
				{ target: "Object", stat: !0, forced: !IG },
				{ getOwnPropertyDescriptor: UG, defineProperty: FG }
		  ),
	...
	var SY = o,
		...
		NY =
			!!DY && DY.values && DY[IY] === DY.values && "values" === DY.values.name,
		UY = function () {
			return jY(kY(this));
		};
	LY(
	...
	(0, Eb.exportTypedArrayStaticMethod)(
		"of",
		function () {
			for (var t = 0, e = arguments.length, r = new ($Y(this))(e); e > t; )
				r[t] = arguments[t++];
			return r;
		},
		mq
			...
			QX(gK, {
				delete: function (t) {
					if (rK(t) && !cK(t)) {
						var e = nK(this);
						return (
							e.frozen || (e.frozen = new YX()),
							mK(this, t) || e.frozen.delete(t)
						);
					}
					return mK(this, t);
				},
				has: function (t) {
					if (rK(t) && !cK(t)) {
						var e = nK(this);
						return (
							e.frozen || (e.frozen = new YX()), bK(this, t) || e.frozen.has(t)
						);
					}
					return bK(this, t);
				},
				get: function (t) {
					if (rK(t) && !cK(t)) {
						...
						return (
							e.frozen || (e.frozen = new YX()),
							bK(this, t) ? wK(this, t) : e.frozen.get(t)
						);
					}
					return wK(this, t);
				},
				set: function (t, e) {
					if (rK(t) && !cK(t)) {
						var r = nK(this);
						r.frozen || (r.frozen = new YX()),
							bK(this, t) ? yK(this, t, e) : r.frozen.set(t, e);
					} else yK(this, t, e);
					return this;
				},
			});
		...
		},
		{
			atob: function (t) {
				...
				var e,
					...
					u = 0;
				if (
					(o.length % 4 == 0 && (o = zK(o, NK, "")),
					(e = o.length) % 4 == 1 || HK(DK, o))
				)
					throw new (IK("DOMException"))(
	...
	var PJ = {
		...
		ZJ =
			...
			(function () {
				try {
					new (kJ("MessageChannel") ||
						LJ("worker_threads").MessageChannel)().port1.postMessage(
						new WeakMap()
					);
				} catch (t) {
	...
	fQ || 25 !== ZJ[JJ] || tQ[JJ];
	_J(
		{ global: !0, constructor: !0, forced: fQ },
	...
	var bQ = oo,
		...
		LQ = function () {
			...
			var t = arguments.length,
				...
				o = new _Q(e);
			return (
				(o.name = PQ), SQ(n, "stack", AQ(1, MQ(o.stack, 1))), xQ(n, this, LQ), n
			);
		},
		...
		BQ = CQ && !FQ && !NQ;
	bQ(
		{ global: !0, constructor: !0, forced: BQ },
	...
	var YQ = p_.clear;
	oo(
		{ global: !0, bind: !0, enumerable: !0, forced: o.clearImmediate !== YQ },
		{ clearImmediate: YQ }
	);
	var $Q = o,
		XQ = ju,
	...
	oZ(
		{ global: !0, bind: !0, enumerable: !0, forced: iZ.setImmediate !== cZ },
		{ setImmediate: cZ }
	);
	var sZ = o,
		fZ = G_,
	...
	oo(
		{
			...
			forced: a(function () {
				return (
					pZ &&
					1 !==
						Object.getOwnPropertyDescriptor(sZ, "queueMicrotask").value.length
				);
			}),
		},
		{
	...
	var AZ,
		...
		I0 = function (t, e) {
			...
			switch ((i0(e, t, o), f)) {
				case "Array":
				case "Object":
					for (c = s0(t), a = 0, u = BZ(c); a < u; a++)
						(s = c[a]), UZ(o, s, I0(t[s], e));
					break;
				case "Map":
				...
				case "Error":
					FZ(o, "message", I0(t.message, e)),
						...
						"AggregateError" === n
							...
							: "SuppressedError" === n &&
							  ((o.error = I0(t.error, e)),
							  (o.suppressed = I0(t.suppressed, e)));
				case "DOMException":
		...
		{ global: !0, enumerable: !0, sham: !$Z, forced: E0 },
		{
			structuredClone: function (t) {
				var e,
					r,
					n =
						zZ(arguments.length, 1) > 1 && !PZ(arguments[1])
							? DZ(arguments[1])
							: void 0,
				...
				void 0 !== o &&
					(r = (function (t, e) {
						if (!_Z(t))
							throw new ZZ("Transfer option cannot be converted to a sequence");
						var r = [];
						LZ(t, function (t) {
							f0(r, DZ(t));
						});
						for (var n, o, i, a, u, c = 0, s = BZ(r), f = new a0(); c < s; ) {
							if (
								((n = r[c++]),
								"ArrayBuffer" === (o = CZ(n)) ? c0(f, n) : n0(e, n))
							)
							...
							if ("ArrayBuffer" !== o) {
								...
								if (void 0 === a)
									throw new e0("This object cannot be transferred: " + o, g0);
								i0(e, n, a);
							} else u0(f, n);
						}
						return f;
	...
	M0(
		{ global: !0, bind: !0, forced: j0.setInterval !== P0 },
		{ setInterval: P0 }
	);
	var _0 = oo,
		k0 = o,
	...
	_0(
		{ global: !0, bind: !0, forced: k0.setTimeout !== L0 },
		{ setTimeout: L0 }
	);
	var D0 = a,
		C0 = u,
		...
		e1 = function (t, e, r) {
			var n = 0;
			for (t = r ? G0(t / 700) : t >> 1, t += G0(t / e); t > 455; )
				(t = G0(t / 35)), (n += 36);
			...
			(this.entries = []),
				...
				void 0 !== t &&
					(O1(t)
						? this.parseObject(t)
						: this.parseQuery(
								"string" == typeof t ? ("?" === X1(t, 0) ? r2(t, 1) : t) : T1(t)
						  ));
		};
	v2.prototype = {
		type: L1,
		...
		parseObject: function (t) {
			...
			if (s)
				for (r = (e = I1(t, s)).next; !(n = c1(r, e)).done; ) {
					if (
						((i = (o = I1(S1(n.value))).next),
						(a = c1(i, o)).done || (u = c1(i, o)).done || !c1(i, o).done)
					)
		...
		parseQuery: function (t) {
			if (t)
				for (var e, r, n = this.entries, o = e2(t, "&"), i = 0; i < o.length; )
					(e = o[i++]).length &&
						((r = e2(e, "=")),
						J1(n, { key: s2(Z1(r)), value: s2(K1(r, "=")) }));
		},
		serialize: function () {
	...
	if (
		(d1(
			y2,
			{
				...
				getAll: function (t) {
					var e = N1(this).entries;
					P1(arguments.length, 1);
					for (var r = T1(t), n = [], o = 0; o < e.length; o++)
						e[o].key === r && J1(n, e[o].value);
					return n;
				},
				has: function (t) {
					for (
				...
				set: function (t, e) {
					...
					P1(arguments.length, 1);
					for (
						var n, o = r.entries, i = !1, a = T1(t), u = T1(e), c = 0;
						c < o.length;
						c++
					)
						(n = o[c]).key === a &&
							(i ? t2(o, c--, 1) : ((i = !0), (n.value = u)));
					i || J1(o, { key: a, value: u }),
						f1 || (this.size = o.length),
						r.updateURL();
				},
				sort: function () {
					var t = N1(this);
				...
				forEach: function (t) {
					for (
						var e,
							r = N1(this).entries,
							n = E1(t, arguments.length > 1 ? arguments[1] : void 0),
							o = 0;
						o < r.length;
		...
		if (
			...
			var E2 = function (t) {
				return (
					m1(this, H1), new B1(t, arguments.length > 1 ? w2(arguments[1]) : {})
				);
			};
			(H1.constructor = E2),
				(E2.prototype = H1),
	...
	var A2,
		...
		n5 = function (t, e, r) {
			...
			if (e) {
				...
				if ((void 0 !== r && (n = new n5(r, !0)), (o = this.parse(a, null, n))))
					throw new X2(o);
	...
	n5.prototype = {
						...
						if (!t6(g6, o)) {
							if (
								...
								if ("" !== l) {
									...
									(c.port = c.isSpecial() && m === _6[c.scheme] ? null : m),
										(l = "");
								}
								if (e) return;
								s = Q6;
					...
					case X6:
						if (((c.scheme = "file"), "/" === o || "\\" === o)) s = K6;
							...
							switch (o) {
								...
								default:
									L6(e6(C2(n, f), "")) ||
										((c.host = r.host), (c.path = C2(r.path)), c.shortenPath()),
										(s = Z6);
									continue;
							}
						}
		...
		setPort: function (t) {
			this.cannotHaveUsernamePasswordPort() ||
				("" === (t = F2(t)) ? (this.port = null) : this.parse(t, $6));
		},
	...
	if (
		...
		u5 && j2(o5, "createObjectURL", I2(u5, $2)),
			c5 && j2(o5, "revokeObjectURL", I2(c5, $2));
	}
	B2(o5, "URL"),
		O2({ global: !0, constructor: !0, forced: !x2, sham: !T2 }, { URL: o5 });
	var s5 = oo,
		f5 = a,
		l5 = FP,
		h5 = mo,
			...
			S5(
				...
				function (t) {
					...
					P5(this, function (t, e) {
						...
						x5(e, 1);
					for (
						var o, i = T5(t), a = T5(r), u = 0, c = 0, s = !1, f = n.length;
						u < f;
	...
	function y3(t, e) {
		return new Promise(function (r, n) {
			...
			if (o.signal && o.signal.aborted)
				return n(new g3("Aborted", "AbortError"));
			...
			if (
				...
				"responseType" in i &&
					(J5
						? (i.responseType = "blob")
						: Z5 && (i.responseType = "arraybuffer")),
				e &&
					"object" == typeof e.headers &&
					!(
						e.headers instanceof i3 ||
						($5.Headers && e.headers instanceof $5.Headers)
					))
			) {
				var u = [];
