...
function t_popup__resizePopup(t) {
	...
	!t ||
		((e = t.querySelector(".t-popup__container")) &&
			...
			(p = 120),
			(t =
				1093 === (n = Number(t.getAttribute("data-record-type"))) ||
				(121 === n && t.querySelector(".t1093"))),
			(364 !== n && 365 !== n) || (p = 30),
			(868 !== n && 331 !== n && 358 !== n && 1013 !== n && 746 !== n && !t) ||
				(p = 0),
			o > window.innerHeight - p
...
function t_popup__addClassOnTriggerButton(t, e) {
	...
	Array.prototype.forEach.call(o, function (t) {
		...
		t.addEventListener("keydown", function (t) {
			13 === t.keyCode &&
				(t = !!(t = t.target).closest('a[href="' + e + '"]') && t) &&
				!window.isMobile &&
				t.classList.add("t-popup__triggered-btn");
		});
}
