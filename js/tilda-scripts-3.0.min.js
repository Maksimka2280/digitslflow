	...
	if (document.querySelector('script[src^="' + t + '"]')) e && e();
		...
		(n.type = "text/javascript"),
			...
			n.addEventListener("error", function (e) {
				var n = e.message || "empty message";
				throw new Error("Failed to load " + t + " script: " + n, { cause: e });
			}),
...
function t_loadCSSFile(t, e) {
	if (document.querySelector('link[href^="' + t + '"]')) e && e();
		...
		(n.rel = "stylesheet"),
			...
			n.addEventListener("error", function (e) {
				var n = e.message || "empty message";
				throw new Error("Failed to load " + t + " style: " + n, { cause: e });
			}),
			document.head.appendChild(n);
	}
}
...
(window.browserLang = (
	...
	t_onReady(function () {
		...
		setTimeout(function () {
			...
			if (
				...
				(document.getElementById("tildacopy") || n) &&
					n.querySelectorAll("div"))
			)
				i + 70 > window.innerHeight &&
					n &&
					n.setAttribute(
						"style",
				...
				for (
					var o = document.body.childNodes, r = [], a = 0;
					a < o.length;
					a++
				) {
					var l = o[a];
	...
	t_onReady(function () {
		...
		var w = document.querySelector(".t-tildalabel"),
			f;
		(f = p
			? Math.max(p.scrollHeight, p.offsetHeight, p.clientHeight, h.offsetHeight)
			: h.offsetHeight) +
			70 <
		window.innerHeight
	...
	(function () {
		...
		function e() {
			...
			for (var n = 0; n < m.length; n++) {
				var i, o;
				(o = (i = m[n]).style).height.indexOf("vh") > -1 &&
					((e = parseInt(o.height) / 100), (d = h + "px"), (o.height = d));
			}
		}
		function n() {
