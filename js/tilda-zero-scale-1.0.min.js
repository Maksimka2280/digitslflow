	...
	if (a) {
		...
		"function" == typeof window.t396__getCurrentScaleFactor
			...
			: (l =
					window.tn &&
					window.tn["ab" + e] &&
					window.tn["ab" + e].scaleFactor) || (l = window.tn_scale_factor);
				...
				p && t396_scale__schedule__scaleTextElements(m),
					...
					o.forEach(function (e) {
						var a = e.element,
							n = e.elementCore,
							o = e.elemType;
						"yes" !== a.getAttribute("data-scale-off") && (a.style.zoom = l),
							"text" === o &&
								t < 1200 &&
								n &&
								!p &&
								(n.style.webkitTextSizeAdjust = "auto"),
	...
	t.read(function () {
		e.forEach(function (e) {
			...
			(a = t396_elem__getWidth(e.element, a)),
				(a = t396_elem__convertPosition__Local__toAbsolute(
					e.element,
					"width",
					a
				));
...
function t396_scale__processBackgroundForShape(e, t, a, l) {
	if ("shape" === a) {
		...
		if (n)
			if (
				((n && n.backgroundImage) || t.getAttribute("data-original")) &&
				"fixed" === n.backgroundAttachment
			) {
